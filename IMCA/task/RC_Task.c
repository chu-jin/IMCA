...
#define CCMRAM  __attribute__((section("ccmram")))//CCM占用
...
void Callback_RC_Handle(RC_Type* rc, uint8_t* buff)
{
	...
	sen_can_comu_1(&hcan1,buff[0],buff[1],buff[2],buff[3],buff[4],buff[5],buff[6],buff[7]);
  sen_can_comu_2(&hcan1,buff[8],buff[9],buff[10],buff[11],buff[12],buff[13],buff[14],buff[15]);
...
//	SendGimbalData(&hcan1,Gimble_vw_data[0],Gimble_vw_data[1],Gimbal_vx_data[0],Gimbal_vx_data[1],0,0,0,0);
	#endif
    ...
    rc->ch5 = ((int16_t)buff[16] | ((int16_t)buff[17] << 8)) & 0x07FF;
    rc->ch5 -= 1024;
...
CCMRAM int16_t RcDeadlineLimit(int16_t input, uint8_t dealine)
{
    int16_t output;
